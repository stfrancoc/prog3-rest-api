...
exports.updatePerson = (req, res, next) => {
    ...
    personDto.update({ _id: req.body.id }, std, (err, data) => {
        if (err) {
            return res.status(400).json(
                {
                    error: err
...
exports.getByCode = (req, res, next) => {
    ...
    personDto.getByCode({ code: req.params.code }, std, (err, data) => {
        if (err) {
            return res.status(400).json(
                {
                    error: err
